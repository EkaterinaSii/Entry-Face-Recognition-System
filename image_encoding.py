...
connection = sqlite3.connect("/home/jetson/Desktop/entry_app/db_management/db_door.db")
...
def encoding():
    ...
    """
    image = face_recognition.load_image_file("/home/jetson/Desktop/entry_app/img_encode.jpg")
...
def save_db(workerId):
    ...
    connection.commit()
    os.remove('/home/jetson/Desktop/entry_app/img_encode.jpg')
